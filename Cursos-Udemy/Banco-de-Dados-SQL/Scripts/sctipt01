...
MODELAGEM LÓGICA - PROGRAMAS DE MODELAGEM MYSQL,WORKBANK.,BRMODELO
MODELAGEM FÍSICA - SCRIPTS DE BANCO 
/*INICIO DE MODELAGEM FÍSICA*/
...
/*VERIFICAR TABELAS DO CAMPO*/
SHOW TABLE;

/*EXIBINDO COLUNAS DENTRO DE UMA TABELA */
DESC CLIENTE;

/*COLOCANDO AS COLUNAS*/
INSERT INTO CLIENTES (NOME,SEXO,EMAIL,TELEFONE,CPF)VALUES('LUIZ','M','LUIZPAULOMEDEIROS77@HOTMAIL.COM','992105813','04692147164')

INSERT INTO clientes (NOME, SEXO, EMAIL, TELEFONE, CPF)
VALUES ('João Silva', 'M', 'joao@example.com', '(11) 91234-5678', '123.456.789-00');
